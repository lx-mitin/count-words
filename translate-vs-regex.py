...
def translate_vs_regex_compare():
	...
	print('For regex, average time: {}\t standard deviation: {}'.format(np.average(regex_times),np.std(regex_times)))
	print('For regex-lower, average time: {}\t standard deviation: {}'.format(np.average(lower_times),np.std(lower_times)))
	print('For translate, average time: {}\t standard deviation: {}'.format(np.average(trans_times),np.std(trans_times)))
	print('For translate-remove, average time: {}\t standard deviation: {}'.format(np.average(remove_times),np.std(remove_times)))
